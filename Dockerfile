...
RUN wget https://repo.teaspeak.de/server/linux/amd64_optimized/TeaSpeak-1.3.6-beta-2.tar.gz &&\
	tar -xzf TeaSpeak-1.3.6-beta-2.tar.gz &&\
	rm TeaSpeak-1.3.6-beta-2.tar.gz &&\
