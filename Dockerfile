...
RUN wget https://repo.teaspeak.de/server/linux/amd64_optimized/TeaSpeak-1.3.13-beta-1.tar.gz &&\
	tar -xzf TeaSpeak-1.3.13-beta-1.tar.gz &&\
	rm TeaSpeak-1.3.13-beta-1.tar.gz
